...
NSString *const kRestartShoppingCart = @"/shoppingcart/index?op_type=restart";

//药品
NSString *const kDrugCategoryList = @"/category/index?op_type=categorylist";
NSString *const kDrugResult = @"/searchg/?op_type=category";
...
//收货地址
NSString *const kAddressList = @"/express/index?op_type=getaddresslist";
NSString *const kAddAddress = @"/express/index?op_type=addaddress";
NSString *const kEditAddress = @"/express/index?op_type=editaddress";
NSString *const kAreaCode = @"/express/index?op_type=searcharea";
NSString *const kDeleteAddress = @"/express/index?op_type=deladdress";
NSString *const kExpressInfo = @"/express/index?op_type=getExpressInfo";
...
//优惠劵
NSString *const kCouponList = @"/couponid/index?op_type=searchmyself";
NSString *const kConvertCoupon = @"/couponid/index?op_type=exchange";

//其它
NSString *const kFeedback = @"/feedback/index?op_type=feedback";
...
+ (NSDictionary *)addLatAndLng:(NSDictionary *)params {
    ...
    if ([YKSUserModel shareInstance].lat > 0) {
        ...
        dic[@"lon"] = @([YKSUserModel shareInstance].lng);
    }
